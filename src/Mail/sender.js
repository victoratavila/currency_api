...
function sendMail(from, sender, recipient, subject, content){
        ...
        <body bgcolor="#222222" width="100%" style="Margin: 0;">
            <center style="width: 100%; background: white;">
                ...
                <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="600" style="margin: auto;" class="email-container">
                    ...
                    <tr>
                        <td>
                            <img src="https://i.imgur.com/nZLA9od.jpg" width="600" height="" alt="alt_text" border="0" align="center" style="width: 100%; max-width: 600px;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px; text-align: center; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                            Muito obrigado! Sua sugestão de cotação foi registrada com sucesso em nossos sistemas e será analisada por nossos desenvolvedores em breve! 🚀 
                            <br><br>
                            <!-- Button : Begin -->
