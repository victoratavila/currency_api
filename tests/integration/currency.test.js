...
const baseURL = 'http://localhost:8080/currency/slug';
...
describe('API Currency values', () => {
    ...
    it('Dolar value must be equal to the current value', async () => {
        ...
        await axios.get(baseURL + '/dolar').then( async dolar => {
            let dolar_response = dolar.data.value;
            ...
            console.log(`expected: ${dollar} | result: ${dolar_response}`)
    ...
    it('Euro value must be equal to the current value', async () => {
        ...
        await axios.get(baseURL + '/euro').then( async euro => {
            let euro_response = euro.data.value;
            ...
            console.log(`expected: ${euroValue} | result: ${euro_response}`)
    ...
    it('Pound value must be equal to the current value', async () => {
        ...
        await axios.get(baseURL + '/libra').then( async pound => {
            let pound_response = pound.data.value;
            console.log(pound_response)
            ...
            console.log(`expected: ${poundValue} | result: ${pound_response}`)
    ...
    it('Canadian dollar value must be equal to the current value', async () => {
        ...
        await axios.get(baseURL + '/dolar-canadense').then( async canadian => {
            let canadian_dolar_response = canadian.data.value;
            ...
            console.log(`expected: ${canadianDolar} | result: ${pound_response}`)
    ...
    it('Iene value must be equal to the current value', async () => {
        ...
        await axios.get(baseURL + '/iene').then( async yen => {
            let iene_response = yen.data.value;
    ...
    //     await axios.get(baseURL + '/dolar-australiano').then( async yen => {
    ...
    //     await axios.get(baseURL + '/peso-mexicano').then( async mexican => {
    ...
    //     await axios.get(baseURL + '/peso-argentino').then( async argentine => {
    ...
    //     await axios.get(baseURL + '/peso-colombiano').then( async colombian => {
    ...
    //     await axios.get(baseURL + '/peso-chileno').then( async chilean => {
    ...
    //     await axios.get(baseURL + '/franco-suico').then( async swissFranc => {
    ...
    //     await axios.get(baseURL + '/yuan').then( async renminbi => {
